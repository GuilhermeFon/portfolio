...
const Hero: React.FC = () => {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-screen flex items-center pt-12 pb-14 overflow-hidden transition-colors duration-300"
    >
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1 z-10">
            ...
            <motion.h1
              ...
              className="text-5xl md:text-7xl font-bold font-display tracking-tight text-zinc-900 dark:text-white mb-6 leading-[1.1]"
            >
