...
const Footer: React.FC = () => {
  ...
  return (
    <footer id="contact" className="bg-zinc-50 dark:bg-zinc-950 border-t border-zinc-200 dark:border-zinc-900 pt-24 pb-12 transition-colors duration-300">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <a 
              href="mailto:contact@guilhermefonseca.dev" 
