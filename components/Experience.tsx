    ...
    positions: [
      {
        ...
        location: "Presencial - Pelotas, RS",
        period: "Março 2026 - Presente",
        highlights: [
          "Migração do site institucional de WordPress para Wagtail (CMS em Django), com ganho de performance de carregamento e SEO.",
          "Funcionalidades no sistema de gestão em Python/Django: modelagem de dados com Django ORM, APIs REST com Django REST Framework, autenticação e painel administrativo via Django Admin.",
          "Tarefas assíncronas e agendadas com Celery e Redis; containerização com Docker e servido via Nginx.",
        ],
      },
      {
        company: "HOX",
        ...
        highlights: [
          ...
          "Dynamox: dashboards para monitoramento preditivo industrial com React, Highcharts e visualizacoes 3D com Three.js/R3F.",
    ...
    positions: [
      {
        ...
        location: "On-site - Pelotas, RS",
        period: "Mar 2026 - Present",
        highlights: [
          "Migrated the institutional website from WordPress to Wagtail (Django CMS), improving load performance and SEO.",
          "Built internal management-system features with Python/Django: Django ORM data modeling, REST APIs with Django REST Framework, authentication, and a customized Django Admin panel.",
          "Set up async and scheduled tasks with Celery and Redis; containerized with Docker and served via Nginx.",
        ],
      },
      {
        company: "HOX",
        ...
        highlights: [
          ...
          "Dynamox: BI dashboards for predictive maintenance using React, Highcharts, and 3D visualizations with Three.js/R3F.",
